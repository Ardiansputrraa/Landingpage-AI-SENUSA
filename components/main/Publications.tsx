      ...
      >
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-400 mb-4 mt-6 sm:mt-10">
            A Novel Feature Representation Method for Automating Genetic Variant
            Classification
          </h2>
          <p className="text-gray-500 text-base sm:text-lg mb-6 sm:mb-8">
            <span className="text-gray-500">Published in: </span>The 5th
            International Conference on Biomedical Engineering (iBioMed 2024)
          </p>
        </motion.div>
      </a>
    </div>
